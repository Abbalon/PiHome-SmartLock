    ...
    def __discover_devices(self, node_id=None):
        ...
        try:
            ...
            self.__xbee_device.send_packet(ATCommPacket(self.__xbee_device.get_next_frame_id(),
                                                        ...
                                                        parameter=None if node_id is None else bytearray(node_id,
                                                                                                         'utf8')),
                                           sync=False)
    ...
    def __calculate_timeout(self):
        ...
        try:
            discovery_timeout = utils.bytes_to_int(
                self.__xbee_device.get_parameter(ATStringCommand.N_QUESTION.command)) / 1000
        except XBeeException:
        ...
        if discovery_timeout is None:
            ...
            try:
                discovery_timeout = utils.bytes_to_int(
                    self.__xbee_device.get_parameter(ATStringCommand.NT.command)) / 10
