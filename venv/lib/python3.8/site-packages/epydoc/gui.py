...
class EpydocGUI:
    ...
    def _update(self, dt, id):
        ...
        if self._progress[0] == 'done':
            p = self._W + DX
        elif self._progress[0] == 'cancel':
            p = -5
        else:
            p = DX + self._W * self._progress[0]
...
def _version():
    ...
    import epydoc
    print
    "Epydoc version %s" % epydoc.__version__
    sys.exit(0)
...
def _usage():
    print
    print
    'Usage: epydocgui [OPTIONS] [FILE.prj | MODULES...]'
    print
    print
    '    FILE.prj                  An epydoc GUI project file.'
    print
